...
<div
  dir="ltr"
  className="flex md:hidden items-center justify-between px-0 py-4"
>
  {/* CTA — LEFT */}
  ...
  <div className="hidden md:flex items-center justify-between px-10 py-6">
    ...
    <ComponentsLink data={NAV_ITEMS} />
    <button className="button w-36 h-10">התחילו עכשיו</button>
  </div>

  <MobileMenu open={open} onClose={() => setOpen(false)} data={NAV_ITEMS} />
</nav>
